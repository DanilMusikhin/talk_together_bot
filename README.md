# ТГ-бот: "Телефоны на СТОЛ!!!""
## Описание
Данный бот является помощником в создании интресного время препровождения. Он выдает задания, которые компания выполняет, тем самым бот способен расшевелить вашу компанию.

## Стек
- aiogram: для ассинхронных запросов от нескольких пользователей и в принципе взаимодействие с API телеграмма
- SQLAlchemy: так как бот имеет свою бд (sqlite)
